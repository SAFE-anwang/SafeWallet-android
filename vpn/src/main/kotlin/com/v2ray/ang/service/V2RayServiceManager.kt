...
//            context.toast(R.string.toast_services_start)
    ...
    fun stopV2rayPoint() {
        val service = serviceControl?.get()?.getService() ?: return
        Log.d("VpnConnectService", "isRunning ${v2rayPoint.isRunning}")
        if (v2rayPoint.isRunning) {
...
//        stopV2RayIntent.`package` = ANG_PACKAGE
        stopV2RayIntent.`package` = service.application.packageName
    ...
    private fun createNotificationChannel(): String {
        val channelId = "RAY_SAFE_WALLET_M_CH_ID"
        val channelName = "SafeWallet Background Service"
