        ...
        return when {
            blockchainType.isEvm -> {
                ...
                BlockchainType.Bitcoin -> {
                    BitcoinAdapter.firstAddress(account.type, token.type, false, false)
                }

                BlockchainType.BitcoinCash -> {
                    BitcoinCashAdapter.firstAddress(account.type, token.type, false, false)
                }

                BlockchainType.Litecoin -> {
                    LitecoinAdapter.firstAddress(account.type, token.type, false, false)
                }

                BlockchainType.Dash -> {
                    DashAdapter.firstAddress(account.type, false, false)
                }

                BlockchainType.ECash -> {
                    ECashAdapter.firstAddress(account.type, false, false)
                }
