...
class SendUsdtToSafeFragment : BaseFragment() {

    private val input by lazy { findNavController().getInput<SendEvmModule.InputUsdtToSafe4>() }
    private val wsafeWallet by lazy { input!!.usdtWallet }
    ...
    private val vmFactory by lazy { SendEvmModule.UsdtToSafeFactory(wsafeWallet, chain) }
    private val viewModel by navGraphViewModels<SendUsdtToSafeViewModel>(R.id.sendUsdtToSafe4Fragment) { vmFactory }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.proceedLiveEvent.observe(viewLifecycleOwner, { sendData ->
            findNavController().navigate(
                R.id.sendEvmFragment_to_sendUsdtToSafe4ConfirmationFragment,
    ...
    private fun setProceedButton(viewModel: SendUsdtToSafeViewModel) {
