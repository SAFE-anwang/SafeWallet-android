package io.horizontalsystems.bankwallet.modules.safe4.linelocksafe.confirmation
...
class SendLineLockConfirmationFragment : BaseComposeFragment() {
    ...
    private val sendEvmTransactionViewModel by navGraphViewModels<SendEvmTransactionViewModel>(R.id.sendLineLockConfirmationFragment) { vmFactory }
    private val feeViewModel by navGraphViewModels<EvmFeeCellViewModel>(R.id.sendLineLockConfirmationFragment) { vmFactory }
    private val nonceViewModel by navGraphViewModels<SendEvmNonceViewModel>(R.id.sendLineLockConfirmationFragment) { vmFactory }
    ...
    override fun GetContent(navController: NavController) {
        SendEvmConfirmationScreen(
            ...
            parentNavGraphId = R.id.sendLineLockConfirmationFragment,
