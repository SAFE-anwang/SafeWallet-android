...
import io.horizontalsystems.bankwallet.modules.swap.liquidity.LiquidityMainModule.PriceImpactViewItem
import io.horizontalsystems.marketkit.models.Token
import io.horizontalsystems.uniswapkit.models.TradeOptions
import java.math.BigDecimal

class LiquidityViewItemHelper(private val numberFormatter: IAppNumberFormatter) {
    ...
    fun priceImpactViewItem(
        trade: LiquidityMainModule.SwapData.UniswapData,
