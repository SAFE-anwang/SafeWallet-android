package io.horizontalsystems.bankwallet.modules.safe4.safe42usdt.confirmation
...
class SendSafe4UsdtConfirmationFragment : BaseFragment() {

    private val logger = AppLogger("send-evm")
    private val sendWsafeViewModel by navGraphViewModels<Safe42UsdtConvertSendViewModel>(R.id.sendSafe4UsdtFragment)
    ...
    private val sendEvmTransactionViewModel by navGraphViewModels<SendEvmTransactionViewModel>(R.id.sendSafe4ToUsdtConfirmationFragment) { vmFactory }
    private val nonceServiceViewModel by viewModels< SendEvmNonceViewModel> { vmFactory }
    private val feeViewModel by navGraphViewModels<EvmFeeCellViewModel>(R.id.sendSafe4ToUsdtConfirmationFragment) { vmFactory }
    ...
    private val transactionData: TransactionData
        get() {
            ...
            return TransactionData(
                ...
                isSafeUsdt = transactionDataParcelable.isSafeUsdt
            )
        }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        sendEvmTransactionViewModel.sendSuccessLiveData.observe(viewLifecycleOwner) {
            ...
            Handler(Looper.getMainLooper()).postDelayed({
                findNavController().popBackStack(R.id.sendSafe4UsdtFragment, true)
            }, 1200)
        }
