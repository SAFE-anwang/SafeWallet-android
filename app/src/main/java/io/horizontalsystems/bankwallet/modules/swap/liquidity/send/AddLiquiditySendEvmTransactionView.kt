...
@Composable
fun AddLiquidityEvmTransactionView(
    transactionViewModel: AddLiquidityTransactionViewModel,
    ...
    ComposeAppTheme {
        ...
        val fee by transactionViewModel.feeLiveData.observeAsState(null)
        val viewState by transactionViewModel.feeViewStateLiveData.observeAsState()
