...
class AppStatusService(
    ...
    private fun getBitcoinForkStatuses(): Map<String, Any> {
        ...
        val blockchainTypesToDisplay = listOf(BlockchainType.Bitcoin, BlockchainType.BitcoinCash, BlockchainType.Dash, BlockchainType.Safe, BlockchainType.Litecoin, BlockchainType.Dogecoin, BlockchainType.ECash)
