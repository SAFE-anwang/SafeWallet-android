...
import io.horizontalsystems.ethereumkit.models.TransactionSource.SourceType
...
class SwapInfoViewModel(
    ...
    private fun buildTxUrl(blockchainTypeUid: String, txHash: String): String? =
        when (BlockchainType.fromUid(blockchainTypeUid)) {
            ...
            BlockchainType.Safe -> "https://${SafeNetWork.getSafeDomainName()}/tx/$txHash"
            BlockchainType.SafeFour -> "${if(Chain.SafeFour.isSafe4TestNetId) "https://safe4testnet.anwang.com" else "https://safe4.anwang.com"}/tx/$txHash"
            BlockchainType.Dogecoin -> "https://blockchair.com/dogecoin/transaction/$txHash"
