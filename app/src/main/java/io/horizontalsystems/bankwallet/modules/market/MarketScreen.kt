...
import io.horizontalsystems.bankwallet.modules.dapp.DAppFragment2
...
import io.horizontalsystems.bankwallet.modules.market.safetweets.CoinTweetsScreen
    ...
    Column(modifier = Modifier.background(color = ComposeAppTheme.colors.tyler)) {
        ...
        HorizontalPager(
            ...
            when (tabs[page]) {
                ...
                MarketModule.Tab.Tweets -> CoinTweetsScreen()
                MarketModule.Tab.DApp -> DAppFragment2(navController)
            }
        }
    }
}
