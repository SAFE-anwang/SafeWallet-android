...
public class PairAddressNonce {

    public static BigInteger nonce(Web3j web3j , String address , String walletAddress) throws Exception {
        List list = new ArrayList<Type>();
        list.add(new Address(walletAddress));
        String encode = FunctionEncoder.encode(MethodID.generate("nonces(address)") , list);
