...
class SelectImportWayFragment: BaseComposeFragment() {
...
private fun ImportWalletScreen(
    ...
    HSScaffold(
        ...
        Column(
            ...
            VSpacer(12.dp)
            ImportOption2(
                title = stringResource(R.string.Restore_Import_Recovery_Phrase),
                description = stringResource(R.string.Restore_Import_Recovery_Phrase_Desc),
                icon = R.drawable.ic_phrase,
                onClick = {
                    navController.navigateWithTermsAccepted {
                        navController.slideFromRight(R.id.restoreSelectWalletFragment,
                            navController.getInput<ManageAccountsModule.Input>())
            ...
            ImportOption2(
                ...
                description = stringResource(R.string.Restore_Import_Private_Key_Desc),
                icon = R.drawable.ic_key,
                onClick = {
                    navController.navigateWithTermsAccepted {
                        navController.slideFromRight(R.id.restorePrivateKeyImportFragment,
                            navController.getInput<ManageAccountsModule.Input>())
