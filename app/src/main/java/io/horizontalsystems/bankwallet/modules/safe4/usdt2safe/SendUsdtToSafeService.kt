...
class SendUsdtToSafeService(
    ...
    private fun syncState() {
        ...
        state = if (addressEnable && amountError == null && evmAmount != null && addressData != null) {
            if(toSafeAddr != null){
                val wsafeKit = UsdtSafeKit.getInstance(adapter.evmKitWrapper.evmKit.chain)
    ...
    fun isSendMinAmount(safeInfoPO: SafeInfoManager.SafeUsdtInfoPO, decimal: Int): Boolean {
