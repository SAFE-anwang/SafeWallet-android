...
class LiquidityTokenService(
    ...
    val state: LiquidityMainModule.SwapCoinCardViewState
        get() = LiquidityMainModule.SwapCoinCardViewState(
            token = token,
            uuid = uuid,
            inputState = LiquidityMainModule.SwapAmountInputState(
                amount = amount,
    ...
    val stateFlow: StateFlow<LiquidityMainModule.SwapCoinCardViewState>
        get() = _stateFlow
