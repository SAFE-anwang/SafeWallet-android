package io.horizontalsystems.bankwallet.modules.safe4.linelock.fee
...
import io.horizontalsystems.bankwallet.modules.send.submodules.fee.SendFeePresenter
...
class LineLockFeeFragment(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        presenterView.lineLockTips.observe(viewLifecycleOwner, Observer { value ->
            context?.let {
                binding.lineLockTips.visibility = View.VISIBLE
                binding.lineLockTips.text = value
            }
        })
