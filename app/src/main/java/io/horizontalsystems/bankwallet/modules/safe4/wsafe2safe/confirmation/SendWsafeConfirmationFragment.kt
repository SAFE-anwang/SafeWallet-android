package io.horizontalsystems.bankwallet.modules.safe4.wsafe2safe.confirmation
...
class SendWsafeConfirmationFragment : BaseFragment() {

    private val logger = AppLogger("send-evm")
    private val sendWsafeViewModel by navGraphViewModels<SendWsafeViewModel>(R.id.sendWsafeFragment)
