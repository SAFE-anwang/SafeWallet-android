...
public class ApplicationLoader1 extends Application {
    ...
    public static File getFilesDirFixed() {
        for (int a = 0; a < 10; a++) {
            File path = ApplicationLoader1.applicationContext.getFilesDir();
            if (path != null) {
                return path;
            }
        }
    ...
    public static void postInitApplication() {
        ...
        try {
            connectivityManager = (ConnectivityManager) ApplicationLoader1.applicationContext.getSystemService(Context.CONNECTIVITY_SERVICE);
            ...
            ApplicationLoader1.applicationContext.registerReceiver(networkStateReceiver, filter);
        } catch (Exception e) {
            e.printStackTrace();
        }
        ...
        try {
            PowerManager pm = (PowerManager) ApplicationLoader1.applicationContext.getSystemService(Context.POWER_SERVICE);
        ...
        ApplicationLoader1 app = (ApplicationLoader1) ApplicationLoader1.applicationContext;
    ...
    public void onCreate() {
        ...
        NativeLoader.initNativeLibs(ApplicationLoader1.applicationContext);
        ...
        AndroidUtilities.runOnUIThread(ApplicationLoader1::startPushService);
    }
    ...
    public static void startPushService() {
        ...
        if (enabled) {
            ...
            PendingIntent pintent = PendingIntent.getService(applicationContext, 0, new Intent(applicationContext, NotificationsService.class), ApplicationLoader.getPendingFlag(0));
    ...
    public static boolean isNetworkOnlineRealtime() {
        try {
            ConnectivityManager connectivityManager = (ConnectivityManager) ApplicationLoader1.applicationContext.getSystemService(Context.CONNECTIVITY_SERVICE);
