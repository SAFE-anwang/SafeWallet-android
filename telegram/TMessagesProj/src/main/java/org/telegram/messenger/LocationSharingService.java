...
public class LocationSharingService extends Service implements NotificationCenter.NotificationCenterDelegate {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (builder == null) {
            ...
            PendingIntent contentIntent = PendingIntent.getActivity(ApplicationLoader.applicationContext, 0, intent2, ApplicationLoader.getPendingFlag(0));
            ...
            builder.addAction(0, LocaleController.getString("StopLiveLocation", R.string.StopLiveLocation), PendingIntent.getBroadcast(ApplicationLoader.applicationContext, 2, stopIntent, ApplicationLoader.getPendingFlag(PendingIntent.FLAG_UPDATE_CURRENT)));
        }
