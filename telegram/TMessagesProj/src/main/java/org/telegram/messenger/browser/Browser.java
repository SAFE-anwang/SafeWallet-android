        ...
        try {
            ...
            if (allowCustom && SharedConfig.customTabs && !internalUri && !scheme.equals("tel")) {
                ...
                if (forceBrowser[0] || allActivities == null || allActivities.isEmpty()) {
                    ...
                    PendingIntent copy = PendingIntent.getBroadcast(ApplicationLoader.applicationContext, 0, new Intent(ApplicationLoader.applicationContext, CustomTabsCopyReceiver.class), ApplicationLoader.getPendingFlag(PendingIntent.FLAG_UPDATE_CURRENT));
                    ...
                    builder.setActionButton(BitmapFactory.decodeResource(context.getResources(), R.drawable.abc_ic_menu_share_mtrl_alpha), LocaleController.getString("ShareFile", R.string.ShareFile), PendingIntent.getBroadcast(ApplicationLoader.applicationContext, 0, share, ApplicationLoader.getPendingFlag(0)), true);
